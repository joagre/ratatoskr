...
#define vecop_cmpeq_int8    _scalar_cmpeq_int8
#define vecop_cmpeq_int16   _scalar_cmpeq_int16
#define vecop_cmpeq_int32   _scalar_cmpeq_int32
#define vecop_cmpeq_int64   _scalar_cmpeq_int64
#define vecop_cmpeq_float32 _scalar_cmpeq_float32
#define vecop_cmpeq_float64 _scalar_cmpeq_float64
...
static inline int8_t _scalar_cmpeq_int8(int8_t a,int8_t b) { return CMPEQ(a,b); }
static inline int16_t _scalar_cmpeq_int16(int16_t a,int16_t b) { return CMPEQ(a,b); }
static inline int32_t _scalar_cmpeq_int32(int32_t a,int32_t b) { return CMPEQ(a,b); }
static inline int64_t _scalar_cmpeq_int64(int64_t a,int64_t b) { return CMPEQ(a,b); }
static inline int32_t _scalar_cmpeq_float32(float32_t a,float32_t b) { return CMPEQ(a,b); }
static inline int64_t _scalar_cmpeq_float64(float64_t a,float64_t b) { return CMPEQ(a,b); }
...
static inline int32_t _scalar_cmpgt_float32(float32_t a,float32_t b) { return CMPGT(a,b); }
static inline int64_t _scalar_cmpgt_float64(float64_t a,float64_t b) { return CMPGT(a,b); }
...
static inline int32_t _scalar_cmplt_float32(float32_t a,float32_t b) { return CMPLT(a,b); }
static inline int64_t _scalar_cmplt_float64(float64_t a,float64_t b) { return CMPLT(a,b); }
