...
typedef ast_ctrl_t*pcc_auxil_t;
...
#define m (*__pcc_in->data.leaf.values.buf[1])
...
#define _0e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.end))
    fprintf(stderr, "BAJS\n");
                    __ = create_import_node(auxil, i, m);
#undef _0e
#undef _0s
#undef _0
#undef m
...
#define _1e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capts.buf[0]->range.end))
    fprintf(stderr, "BAJS\n");
    __ = create_identifier_node(auxil, (char*)(_1));
#undef _1e
#undef _1s
#undef _1
#undef _0e
...
static void pcc_action_ModulePath_0(satie_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define i (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
#define _0e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.end))
    fprintf(stderr, "BAJS\n");
    __ = create_module_path_node(auxil, i);
#undef _0e
#undef _0s
#undef _0
#undef i
...
static void pcc_action_ModulePath_1(satie_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define i (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
#define _0e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.end))
                        fprintf(stderr, "BAJS\n");
    __ = add_module_path_identifier(auxil, __, i);
#undef _0e
#undef _0s
#undef _0
#undef i
...
static void pcc_action_ModulePath_2(satie_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define i (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
#define _0e ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.end))
                        fprintf(stderr, "BAJS\n");
    __ = set_module_path_wildcard(auxil, __);
#undef _0e
#undef _0s
#undef _0
#undef i
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_IfElse(pcc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_Import(pcc_context_t *ctx) {
    ...
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ModulePath, &chunk->thunks, &(chunk->values.buf[1]))) goto L0000;
    {
        pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_Import_0, 2, 0);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_ModulePath(pcc_context_t *ctx) {
    ...
    {
        pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_ModulePath_0, 1, 0);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->cur;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    }
    {
        ...
        for (i = 0;; i++) {
            ...
            ctx->cur++;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_Identifier, &chunk->thunks, &(chunk->values.buf[0]))) goto L0001;
            {
                pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_ModulePath_1, 1, 0);
                thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
                thunk->data.leaf.capt0.range.start = chunk->pos;
                thunk->data.leaf.capt0.range.end = ctx->cur;
                pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    }
    {
        ...
        ctx->cur++;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_ModulePath_2, 1, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->cur;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_Exprs(pcc_context_t *ctx) {
    ...
    ctx->level++;
    {
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_Exprs, &chunk->thunks, NULL)) goto L0002;
        goto L0001;
    L0002:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_Expr(pcc_context_t *ctx) {
    ...
    L0002:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_IfElse, &chunk->thunks, NULL)) goto L0003;
        goto L0001;
    L0003:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_IfElse(pcc_context_t *ctx) {
    pcc_thunk_chunk_t *const chunk = pcc_thunk_chunk__create(ctx);
    chunk->pos = ctx->cur;
    PCC_DEBUG(ctx->auxil, PCC_DBG_EVALUATE, "IfElse", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->buffer.len - chunk->pos));
    ctx->level++;
    if (
        pcc_refill_buffer(ctx, 2) < 2 ||
        (ctx->buffer.buf + ctx->cur)[0] != 'i' ||
    ...
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_MATCH, "IfElse", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    return chunk;
L0000:;
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_NOMATCH, "IfElse", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    pcc_thunk_chunk__destroy(ctx, chunk);
    return NULL;
}
