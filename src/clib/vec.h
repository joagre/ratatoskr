...
VEC_LOCAL int vec_vinit(vec_t* vp, allocator_t* alloc,
			size_t size, size_t width, void* base) VEC_API;
...
VEC_LOCAL void vec_neg(vec_t* a, vec_t* c) VEC_API;
VEC_LOCAL void vec_add(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_sub(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_min(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_max(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_cmpeq(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_cmpgt(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_cmplt(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_bnot(vec_t* a, vec_t* c) VEC_API;
VEC_LOCAL void vec_band(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_bor(vec_t* a, vec_t* b, vec_t* c) VEC_API;
VEC_LOCAL void vec_bxor(vec_t* a, vec_t* b, vec_t* c) VEC_API;

#if defined(__x86__) || defined(__x86_64__)
// name must be at least 13 chars long
VEC_LOCAL char* cpuid_vendor_name(char* name) VEC_API;
VEC_LOCAL int cpuid_feature(uint32_t* ecx, uint32_t* edx) VEC_API;
VEC_LOCAL int cpuid_get_highfunsup() VEC_API;
VEC_LOCAL int cpuid_amd_feature(uint32_t* ecx, uint32_t* edx) VEC_API;
VEC_LOCAL char* cpuid_amd_brand_string(char* name) VEC_API;
#endif
