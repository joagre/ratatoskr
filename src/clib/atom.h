...
ATOM_LOCAL void atom_reset(atom_table_t* tab) ATOM_API;
...
ATOM_LOCAL ssize_t atom_len(char* atm) ATOM_API;
ATOM_LOCAL char* atom_name(char* atm) ATOM_API;
