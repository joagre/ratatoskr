...
#define BIGNUM_LOCAL static
#if defined(__WIN32__) || defined(_WIN32)
#define BIGNUM_API
#else
#define BIGNUM_API __attribute__ ((unused))
#endif

BIGNUM_LOCAL int bignum_copy(bignum_t* src, bignum_t* dst) BIGNUM_API;
BIGNUM_LOCAL int bignum_copy_resize(bignum_t* src, bignum_t* dst, int min_size)  BIGNUM_API;
BIGNUM_LOCAL int bignum_small(bignum_t* x, digit_t d) BIGNUM_API;

BIGNUM_LOCAL int bignum_is_zero(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_is_one(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_is_odd(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_is_even(bignum_t* x) BIGNUM_API;

BIGNUM_LOCAL int bignum_comp(bignum_t* x, bignum_t* y) BIGNUM_API;
BIGNUM_LOCAL int bignum_abs_comp(bignum_t* x, bignum_t* y) BIGNUM_API;

BIGNUM_LOCAL int bignum_add(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_subtract(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_multiply(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_div(bignum_t* x, bignum_t* y, bignum_t* q) BIGNUM_API;
BIGNUM_LOCAL int bignum_rem(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_mod(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_divrem(bignum_t* x, bignum_t* y, bignum_t* q, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bsl(bignum_t* x, int y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bsr(bignum_t* x, int y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_negate(bignum_t* x, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_abs(bignum_t* x, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_band(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bor(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bxor(bignum_t* x, bignum_t* y, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bnot(bignum_t* x, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bit_test(bignum_t* x, unsigned pos) BIGNUM_API;
BIGNUM_LOCAL int bignum_bit_set(bignum_t* x, unsigned pos, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_byte_set(bignum_t* x, unsigned pos, uint8_t b, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bit_clear(bignum_t* x, unsigned pos, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_bit_toggle(bignum_t* x, unsigned pos, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_ffs(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_clz(bignum_t* x) BIGNUM_API;     // number of leading 0-bits from MSB, or 0
BIGNUM_LOCAL int bignum_ctz(bignum_t* x) BIGNUM_API;     // number of trailing 0-bits from LSB, or 0
BIGNUM_LOCAL int bignum_clrsb(bignum_t* x) BIGNUM_API;   // number of redunant bits from MSB
BIGNUM_LOCAL int bignum_popcount(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_parity(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_byte_size(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_bit_size(bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_powmod(bignum_t* x, bignum_t* n, bignum_t* m, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_powmod_prime(bignum_t* a, bignum_t* b, bignum_t* p, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_powmod_two_prime (bignum_t* a,bignum_t* b, bignum_t* p1,bignum_t* p2, bignum_t* r) BIGNUM_API;
BIGNUM_LOCAL int bignum_gcd(bignum_t* x, bignum_t* y, bignum_t* gcd) BIGNUM_API;
BIGNUM_LOCAL int bignum_egcd(bignum_t* a, bignum_t* b, bignum_t* gcd,
			     bignum_t* x,bignum_t* y) BIGNUM_API;
BIGNUM_LOCAL int bignum_from_strn(char* ptr, int len, bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL int bignum_from_string(char* ptr, bignum_t* x) BIGNUM_API;
BIGNUM_LOCAL char* bignum_to_string(bignum_t* x, char* ptr, int sz) BIGNUM_API;
